...
var (
	pkg       = flag.String("assert-path", "github.com/ungtb10d/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/ungtb10d/testify/_codegen
